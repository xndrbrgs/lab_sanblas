  ...
  return (
    <div className="bg-gray-50 px-6 py-24 sm:py-32 lg:px-8">
      <div className="relative w-full max-w-lg">
        <div className="absolute top-0  w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob"></div>
        <div className="absolute top-0  w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob"></div>
        <div className="absolute top-0  w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob"></div>
      </div>
      <div className="mx-auto max-w-2xl text-center relative">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          El mejor servicio. <br /> A cualquier hora.
        </h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Por cualquier duda o pregunta, mandenos un email abajo
        </p>
      </div>
      <form
        action="#"
