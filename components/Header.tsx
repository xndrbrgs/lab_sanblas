...
const products = [
  {
    name: "Pruebas",
    description: "Todas las prebas que ofrecemos",
    href: "/servicios/pruebas",
    icon: ClipboardDocumentIcon,
  },
  {
    name: "Servicios al Hogar",
    description: "Laboratorios San Blas le ofrecen el servicio a domicilio",
    href: "/servicios/servicios-al-hogar",
    icon: HomeIcon,
  },
  {
    name: "Pruebas Especializadas",
    description: "Lista de preubas especializadas",
    href: "/servicios/especializadas",
...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 shadow-md"
        aria-label="Global"
      >
